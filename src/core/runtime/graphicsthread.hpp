...
#include "graphics/rendering/frame_context.hpp"
#include "graphics/rendering/shared_rendering_resources.hpp"
#include "graphics/rendering/transient_rendering_resources.hpp"
